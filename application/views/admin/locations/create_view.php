                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Title" class="form-control"
                                   name="job_location_title" id="job_location_title" value="<?php echo set_value('job_location_title'); ?>"
                                   required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Slug" class="form-control"
                                   name="job_location_slug" id="job_location_slug" value="<?php echo set_value('job_location_slug'); ?>"
                                   required>
