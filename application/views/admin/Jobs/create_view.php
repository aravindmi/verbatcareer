                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="job_location_id">
                                ...
                                <?php if(count($job_locations) > 0){foreach ($job_locations as $job_location) {?>
                                    ...
                                    <option value="<?php echo $job_location->job_category_id;?>"  <?php echo  set_select('job_location_id', $job_location->job_location_id); ?>><?php echo $job_location->job_location_title;?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Sub Location" class="form-control"
                                   name="job_experience" value="<?php echo set_value('job_sub_location'); ?>"  required>
