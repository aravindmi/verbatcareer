<h2 class="page-header">Categories
    <a href="<?php echo site_url('admin/categories/create/'); ?>" class="btn btn-info pull-right" title="Create"><i
                        ...
                        <?php foreach ($data as $d) { ?>
                            <tr>
                                ...
                                <td class="table-bordered">
                                    <?php echo $d->job_category_title; ?>
                                </td>


                                <td class="table-bordered">
                                    <?php echo $d->job_category_slug;  ?>
                                ...
                                <td class="table-bordered">
                                    ...
                                    <a href="<?php echo site_url('admin/categories/update/' . $d->job_category_id.'/'.$d->job_category_slug); ?>"
                                       class="btn btn-primary btn-circle" title="Edit"><i class="fa fa-edit"></i></a>

                                    <a href="<?php echo site_url('admin/categories/delete/' . $d->job_category_id); ?>"
