                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Title" class="form-control"
                                       name="job_category_title" id="job_category_title" value="<?php echo set_value('job_category_title',$data->job_category_title); ?>"
                                       required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Slug" class="form-control"
                                       name="job_category_slug" id="job_category_slug" value="<?php echo set_value('job_category_slug',$data->job_category_slug); ?>"
                                       required>
