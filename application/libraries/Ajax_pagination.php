...
class Ajax_pagination{
	...
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="col-md-6"><div class="dataTables_paginate paging_simple_numbers"><ul class="pagination" style="margin: 0 0 !important;">';
   ...
   var $show_count      = true;
	...
	function create_links()
	{
		...
		if ($num_pages == 1)
		{
            $info = 'Showing Total of : <b>' . $this->total_rows.'</b>';
			return $info;
		}
      ...
      if ($this->show_count)
      {
		...
		$output = $this->full_tag_open.$output.$this->full_tag_close.'<div class="col-md-6"><div class="pull-right">'.$output_text.'</div></div>';
